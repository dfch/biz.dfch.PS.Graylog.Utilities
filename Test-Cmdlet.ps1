...
This Cmdlet echos the input to the console.

.EXAMPLE

Test-Cmdlet "hello, world"
hello, world
...
Online Version: http://dfch.biz/biz/dfch/PS/Graylog/Utilities/Test-Cmdlet/
...
http://dfch.biz/biz/dfch/PS/Graylog/Utilities/biz.dfch.PS.Graylog.Utilities.psd1/
...
[CmdletBinding(
	...
	ConfirmImpact = 'Low'
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Graylog/Utilities/Test-Cmdlet/'
)]
[OutputType([string])]
PARAM 
(
	# Specifies the String to echo on the console
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Test-Cmdlet; } 

# SIG # Begin signature block
# MIIaVQYJKoZIhvcNAQcCoIIaRjCCGkICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU51XIk5XgwRwAz5ivTsTq26j+
# KTugghURMIIDdTCCAl2gAwIBAgILBAAAAAABFUtaw5QwDQYJKoZIhvcNAQEFBQAw
...
# hkiG9w0BCQQxFgQUknuYD6fScRL+QlJBU/xb18sxoZUwDQYJKoZIhvcNAQEBBQAE
# ggEAcuRve2tSfPMA9CyQ4DUGKthSvbr4eB5omRm1pyXDqHvvR5l3c+Q200HAm3qc
# cNkvHFGdf+kP3s3SgzCzJwwKGyprtKxbrmKw2tVfUoyzuyleNPCuRj7SNrSfYdK8
# 4fLGC8FdErgd+ie14FaRaKBgg8SFi+aF6AsHXbwJHkK7IaI2RkMgL2QIjlRn+V1N
# hd8ZZHSc5RaQfH7UrcT9EZGU5GML5ndKJJ03vnv8scwbYYipXJjz0Y8LBSgVx1Lp
# JrIcgHHDuORU1OOOx1tB648WMwArBSY6BqldO/BgzvYC/HBVODuZ1yzKpXraSb1D
# MD8sbatWDEar5bFIjbi1mp1GcqGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIB
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNTAzMTYwNjAwMDBaMCMGCSqGSIb3DQEJBDEW
# BBQQhLWSayR2LFPslcNCKMuZ/PHJajCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcw
...
# AQEBBQAEggEAECPwEbUjngUz9h+qPQPC7x+zfKX5t+9+QZi2yvjSs1OOTQh8Gn9g
# IANArlIlZh1PVM5PRdkA2k7i2rsz2OxApOmDAvdL5Iqze4Mw9r+7lwc2y2b2oYXp
# LqwB7KForgGwg2/8ypFLYmP8TVHYJ6dBlozCEXi/5RPFVLYV1sZ4n6sLCqC8QdO5
# 2gJY4cgwPdTMRntXTocam0AVEqG2+IQ5WQpzcgMZZDWG+xvkqqR1QKG2xJrtVLt3
# IHyftC4yqhX5GMuMgbYMzaTEeh2Hq7OkK+/nk8XM4Z5TaJo6yZCes6y3jGO7OFzE
# 8Mff49l5KPNLCJMyLbytasJTtrLmgHNrBg==
